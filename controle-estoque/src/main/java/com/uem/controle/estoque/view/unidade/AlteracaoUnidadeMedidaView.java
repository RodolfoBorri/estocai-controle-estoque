...
public class AlteracaoUnidadeMedidaView extends ViewBase{
	...
	public static void run() {
		try {
			AlteracaoUnidadeMedidaView window = new AlteracaoUnidadeMedidaView();
	...
	public AlteracaoUnidadeMedidaView() {
	...
	private void montaCabecalhoCompleto() {
		...
		this.add(montaTituloTela("ALTERAÇÃO DE UNIDADE"));		
	}
					...
					if(errors.equals("")) {
						int result = JOptionPane.showConfirmDialog(frame,
					        ...
					        if (result == JOptionPane.YES_OPTION) {
					        	unidadeMedidaController.alteraUnidade(unidadeMedidaDTO);
	...
	private String validaCamposUnidade(UnidadeMedidaDTO unidadeMedidaDTO) {
		return unidadeMedidaController.validaCamposUnidade(unidadeMedidaDTO, "Alteracao"); 
	}	
