...
import com.uem.controle.estoque.view.produto.InclusaoProdutoView;

@Component
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class ExclusaoUnidadeMedidaView extends ViewBase{
	...
	public ExclusaoUnidadeMedidaView() {
	...
	private void montaCabecalhoCompleto() {
		...
		this.add(montaTituloTela("EXCLUSÃO DE UNIDADE"));		
	}
			...
			public void mouseClicked(MouseEvent e) {
				...
				int result = JOptionPane.showConfirmDialog(frame,
			        ...
			        if (result == JOptionPane.YES_OPTION) {
			        	erros = unidadeMedidaController.removeUnidade(textFieldUnidade.getText());
	...
	private void buscaUnidade() {
		...
		catch(Exception ex)
		{
			...
			textFieldUnidade.setEditable(true);
		}
