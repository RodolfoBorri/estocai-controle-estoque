...
public class ConsultaClasseProdutoView extends ViewBase{
	...
	public static void run() {
		try {
			ConsultaClasseProdutoView window = new ConsultaClasseProdutoView();
	...
	public ConsultaClasseProdutoView() {
	...
	private void montaCabecalhoCompleto() {
		...
		this.add(montaTituloTela("CONSULTA DE CLASSE DE PRODUTO"));		
	}
