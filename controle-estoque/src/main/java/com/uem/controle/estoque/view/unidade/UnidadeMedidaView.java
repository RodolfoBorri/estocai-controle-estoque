...
public class UnidadeMedidaView extends ViewBase{
	...
	public static void run() {
		try {
			UnidadeMedidaView window = new UnidadeMedidaView();
	...
	private void montaCabecalhoCompleto() {
		...
		this.add(montaTituloTela("CADASTRO DE UNIDADES"));		
	}
	...
	private void initialize() {
        ...
        btnInclusaoProduto.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				InclusaoUnidadeMedidaView inclusaoUnidadeMedidaView = ApplicationContextProvider.getContext().getBean(InclusaoUnidadeMedidaView.class);				
				inclusaoUnidadeMedidaView.frame.setVisible(true);
			}
		});
		...
		btnAlteracaoProduto.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				frame.setVisible(false);
				AlteracaoUnidadeMedidaView alteracaoUnidadeMedidaView = ApplicationContextProvider.getContext().getBean(AlteracaoUnidadeMedidaView.class);				
				alteracaoUnidadeMedidaView.frame.setVisible(true);
			}
		});
		...
		btnConsultaProduto.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				frame.setVisible(false);
				ConsultaUnidadeMedidaView consultaUnidadeMedidaView = ApplicationContextProvider.getContext().getBean(ConsultaUnidadeMedidaView.class);				
				consultaUnidadeMedidaView.frame.setVisible(true);
			}
		});
		...
		btnExclusaoProduto.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				frame.setVisible(false);
				ExclusaoUnidadeMedidaView exclusaoUnidadeMedidaView = ApplicationContextProvider.getContext().getBean(ExclusaoUnidadeMedidaView.class);				
				exclusaoUnidadeMedidaView.frame.setVisible(true);
			}
		});
